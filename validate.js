...
function validarISBNInside(elemento,errorISBN, errorISBNExiste){
	//console.log("entra aqui" + elemento);

    if (!validarISBN(elemento)){
		...
		elemento.classList.remove("is-valid");
        mostrar(errorISBN);
		nomostrar(errorISBNExiste);
		//console.log("entra aqui MAL");
        ...
        nomostrar(errorISBN);
		nomostrar(errorISBNExiste);
		//console.log("entra aqui BIEN");

        var titulo;
        const xhttp = new XMLHttpRequest();

		//console.log("entra aqui AJAX");
        xhttp.open("GET", "getISBN.php?isbn="+elemento.value);
        xhttp.send();
        xhttp.onload = function() {
           titulo = this.responseText;
            if(titulo!=null&&titulo!=""){
                nomostrar(errorISBN);
				elemento.classList.add("is-invalid");
				elemento.classList.remove("is-valid");
        		mostrar(errorISBNExiste);
            }
        }
    }
}
